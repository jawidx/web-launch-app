...
var LaunchApp = /** @class */ (function () {
    ...
    LaunchApp.prototype.download = function (opt) {
        ...
        if (detector_1.detector.browser.name == 'micromessenger') {
    ...
    LaunchApp.openChannel = {
        ...
        store: {
            open: function (noTimeout) {
                // 超时处理
                if (!exports.inWexin && !noTimeout && this.timeoutDownload) {
                    this._setTimeEvent();
                }
                if (this.options.useYingyongbao || (this.options.useYingyongbao == undefined && this.configs.useYingyongbao)) {
                    var pageConf = deepMerge(this.configs.deeplink.yyb, { param: this.options.param });
