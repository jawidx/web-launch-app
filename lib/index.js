...
exports.LaunchApp = exports.detector = exports.ua = exports.copy = void 0;
...
var LaunchApp = /** @class */ (function () {
    ...
    LaunchApp.prototype._getOpenMethod = function () {
        ...
        if (useUniversalLink || useAppLink) {
            if (autodemotion && ((utils_1.isIos && !utils_1.enableUniversalLink) || (utils_1.isAndroid && !utils_1.enableApplink))) {
                return scheme;
            }
            return link;
        }
        ...
        try {
            ...
            if (opt.useGuideMethod || (this.options.useGuideMethod == undefined && this.configs.useGuideMethod)) {
                ...
                switch (type) {
                    case 'link':
                        tmpOpenMethod = link;
                        if (opt.autodemotion && ((utils_1.isIos && !utils_1.enableUniversalLink) || (utils_1.isAndroid && !utils_1.enableApplink))) {
            ...
            utils_1.locationCall(this.options.landingPage || this.configs.landingPage);
        }
    };
    /**
     * download package
    ...
    LaunchApp.prototype.download = function (opt) {
        ...
        if (utils_1.inWeixin) {
            ...
            utils_1.locationCall(opt.landingPage || this.configs.landingPage);
        }
    };
    /**
     * 检验版本
