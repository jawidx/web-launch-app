...
exports.LaunchApp = exports.locationCall = exports.iframeCall = exports.supportLink = exports.detector = exports.ua = exports.copy = void 0;
...
function supportLink() {
    ...
    if (utils_1.enableUniversalLink) {
        switch (detector_1.detector.browser.name) {
            case 'uc':
            case 'qq':
                supportLink = false;
