...
exports.inWexin = detector_1.detector.browser.name === 'micromessenger';
...
var LaunchApp = /** @class */ (function () {
    ...
    LaunchApp.prototype._getOpenMethod = function () {
        var _a = LaunchApp.openChannel, wxGuide = _a.wxGuide, yingyongbao = _a.yingyongbao, link = _a.link, scheme = _a.scheme, unknown = _a.unknown;
        if (exports.inWexin) {
        ...
        if ((this.configs.useUniversalLink && exports.enableULink) || (this.configs.useAppLink && exports.enableApplink)) {
            return link;
        }
    ...
    LaunchApp.prototype.open = function (opt, callback) {
        try {
            ...
            var _a = LaunchApp.openChannel, scheme = _a.scheme, link = _a.link, wxGuide = _a.wxGuide, yingyongbao = _a.yingyongbao, store = _a.store, unknown = _a.unknown;
            ...
            if (exports.inWexin) {
                if (opt.wxGuideMethod) {
                    ...
                    else if (exports.isIos || exports.isAndroid) {
                ...
                switch (type) {
                    case 'link':
                        if ((exports.isIos && exports.enableULink) || (exports.isAndroid && exports.enableApplink)) {
                            tmpOpenMethod = link;
                        }
                        else {
                            tmpOpenMethod = scheme;
    ...
    LaunchApp.openChannel = {
        scheme: {
            ...
            open: function (url) {
                ...
                if (exports.isIos && detector_1.detector.browser.name == 'safari') {
                    locationCall(url);
                }
                else {
                    iframeCall(url);
